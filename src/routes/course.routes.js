...
// Timetable
router.get("/:courseId/timetable", auth, timetableCtrl.getTimetableForCourse);
router.post("/:courseId/timetable", auth, timetableCtrl.createTimetableEntry);
router.delete("/timetable/:id", auth, timetableCtrl.deleteTimetableEntry);
router.get("/:courseId/timetable/mine", auth, timetableCtrl.getMyScheduleForCourse);
router.put("/timetable/:timetableId/override", auth, timetableCtrl.setMyOverride);
router.delete("/timetable/:timetableId/override", auth, timetableCtrl.deleteMyOverride);
// Attendance
router.post("/:courseId/attendance", auth, attendanceCtrl.signAttendance);
router.get("/:courseId/attendance/mine", auth, attendanceCtrl.getMyAttendanceForCourse);
router.get("/:courseId/attendance", auth, attendanceCtrl.getAttendanceForCourse);
