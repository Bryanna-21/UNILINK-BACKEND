...
// Shared by two features: signup email verification and optional
// login 2FA. `purpose` distinguishes which flow a given code belongs
// to, so a code generated for signup verification can't accidentally
// be accepted to complete a login, and vice versa.
const otpCodeSchema = new mongoose.Schema({
  userId: { type: String, required: true },
  code: { type: String, required: true },
  purpose: { type: String, enum: ["verify_signup", "login_2fa"], required: true },
